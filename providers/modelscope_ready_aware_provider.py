#!/usr/bin/env python3
"""Ready-aware wrapper for the resilient Echoes Cinema proof provider.

The provider HTTP server is intentionally reachable while the real model loads.
Render requests must therefore fail as temporary unavailability (HTTP 503),
not as an internal server error (HTTP 500), until realModelLoaded is true.
"""
